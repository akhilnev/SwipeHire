...
/**
 * This class represents the profile activity in the application.
 * It extends the AppCompatActivity class and is responsible for displaying the user's profile.
 *
 * @author Aryan Rao
 */
