...
/**
 * A fragment that represents a list of companies.
...
public class CompaniesFragment extends Fragment {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(SignUpActivity.isManager == true) {
                    ...
                    Toast.makeText(getContext(), "Only managers can enter", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    /**
     * Called when the fragment's view is no longer needed and will be destroyed.
     */
    @Override
