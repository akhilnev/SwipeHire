...
/**
 ...
 This class represents the ListViewer activity, where the user can view a list of companies and search for a specific company.
 When the user clicks on a company in the list, it navigates to the CompanyData activity.
 @author - Hrishikesha Kyathsandra
 */
public class ListViewer extends AppCompatActivity {
    /**
     * Called when the activity is starting. It initializes the UI components and sets up the list of companies.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                response -> {
                    ...
                    String[] companyNames = response.toString().split(",");
