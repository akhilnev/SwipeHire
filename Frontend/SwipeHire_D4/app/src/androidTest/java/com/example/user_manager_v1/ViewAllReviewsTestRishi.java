...
public class ViewAllReviewsTestRishi {
    ...
    @Test
    public void viewAllReviewsTestRishi() {
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.viewallreviews), withText("View All Reviews"),
                        childAtPosition(
                                childAtPosition(
        ...
        DataInteraction textView = onData(anything())
                .inAdapterView(allOf(withId(R.id.listcompanies2),
                        childAtPosition(
