        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.jobtype),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("SWE"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.salary),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("450K"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.location),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("SA"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.reqskills),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Java"), closeSoftKeyboard());
    }
