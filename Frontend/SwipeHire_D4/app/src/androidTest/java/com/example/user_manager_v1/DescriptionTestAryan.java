...
public class DescriptionTestAryan {
    ...
    @Test
    public void descriptionTestAryan() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.descid),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("This is a test description of a company"), closeSoftKeyboard());
    }
