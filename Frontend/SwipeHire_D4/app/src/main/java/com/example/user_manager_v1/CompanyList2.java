...
public class CompanyList2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_list2);

        ArrayList<String> akhiList = new ArrayList<>();
        ListView listView = findViewById(R.id.listcompanies2);
        ...
        RequestQueue queue = Volley.newRequestQueue(CompanyList2.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                for(int i = 0; i < akhiList.size(); i++){
                    if(position == i){
                        ...
                        editor.apply();
                        startActivity(new Intent(CompanyList2.this, ViewAllReviews.class));
                    }
                }
            }
        ...
        SearchView searchView = findViewById(R.id.searchcompanies2);
